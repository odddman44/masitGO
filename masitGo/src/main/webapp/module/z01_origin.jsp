<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    import="java.util.*"
    %>
<!-- 원래 메인페이지에 있던 내용물을 백업용으로 빼둔 모듈입니다. 필요하면 사용하되, 가급적이면  
	sample에 있는 html 파일의 코드를 보고 참고합시다. 
	즉, 무시하면 되는 파일입니다 ㅎㅎ -->
<div class="row">
	...
	<div class="col-md-6 grid-margin stretch-card">
		<div class="card tale-bg">
			<div class="card-people mt-auto">
				<img src="${path}/com/images/dashboard/people.svg" alt="people">
		...
		<div class="card">
			<div class="card-body">
				...
				<ul class="icon-data-list">
					<li>
						<div class="d-flex">
							<img src="${path}/com/images/faces/face1.jpg" alt="user">
							<div>
					...
					<li>
						<div class="d-flex">
							<img src="${path}/com/images/faces/face2.jpg" alt="user">
							<div>
					...
					<li>
						<div class="d-flex">
							<img src="${path}/com/images/faces/face3.jpg" alt="user">
							<div>
					...
					<li>
						<div class="d-flex">
							<img src="${path}/com/images/faces/face4.jpg" alt="user">
							<div>
					...
					<li>
						<div class="d-flex">
							<img src="${path}/com/images/faces/face5.jpg" alt="user">
							<div>
