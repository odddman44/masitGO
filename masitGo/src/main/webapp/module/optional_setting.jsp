		...
		<div class="tab-pane fade" id="chats-section" role="tabpanel"
			...
			<ul class="chat-list">
				<li class="list active">
					<div class="profile">
						<img src="${path}/com/images/faces/face1.jpg" alt="image"><span
							class="online"></span>
					</div>
					<div class="info">
						<p>Thomas Douglas</p>
				...
				<li class="list">
					<div class="profile">
						<img src="${path}/com/images/faces/face2.jpg" alt="image"><span
							class="offline"></span>
					</div>
					<div class="info">
				...
				<li class="list">
					<div class="profile">
						<img src="${path}/com/images/faces/face3.jpg" alt="image"><span
							class="online"></span>
					</div>
					<div class="info">
						<p>Daniel Russell</p>
				...
				<li class="list">
					<div class="profile">
						<img src="${path}/com/images/faces/face4.jpg" alt="image"><span
							class="offline"></span>
					</div>
					<div class="info">
				...
				<li class="list">
					<div class="profile">
						<img src="${path}/com/images/faces/face5.jpg" alt="image"><span
							class="online"></span>
					</div>
					<div class="info">
				...
				<li class="list">
					<div class="profile">
						<img src="${path}/com/images/faces/face6.jpg" alt="image"><span
							class="online"></span>
					</div>
					<div class="info">
						<p>Sarah Graves</p>
