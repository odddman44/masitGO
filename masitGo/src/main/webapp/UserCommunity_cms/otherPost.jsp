...
<body>
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <!-- partial -->
      <!-- 왼쪽 사이드바 모듈 -->
      <%@ include file = "left_sidebarOther.jsp" %>
      ...
      <div class="main-panel">
			...
			(div class="row" 등을 잘 활용하면 이쁘게 구성할 수 있긴 함. 자세한건 샘플 html 참조.) -->
				<%
				String writer_id = request.getParameter("writer_id"); // 전달받은 다른 사람 아이디 가져오기
				%>
					<!-- partial -->
					<div class="main-panel">
						<div class="content-wrapper">
							...
							<div class="row">
								<div class="col-lg-12 grid-margin stretch-card">
									<div class="card">
										<div class="card-body">
											<h4 class="card-title"><%=writer_id%>님의 게시글</h4>
											<div class="table-responsive">
												<table class="table table-striped">
													...
													List<PostDTO> plist=dao.getMyPost(writer_id);
													...
													<tr>
															...
															<td><%=post.getViews() %></td>
															<td><%=post.getBoard_name() %></td>
															<td><a href="${path}/Board_okw/readBoard_Map.jsp?post_id=<%=post.getPost_id() %>">Go</a></td>
														</tr>
														<%} %>
													</tbody>
												</table>
